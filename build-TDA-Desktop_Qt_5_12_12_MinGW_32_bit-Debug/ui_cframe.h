...
public:
    ...
    QComboBox *CB_ORDEN;
    QGroupBox *GB_orden;
    QRadioButton *rb_post;
    QRadioButton *rb_inorden;
    QRadioButton *rb_preorden;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *cframe)
    {
        ...
        GB_orden = new QGroupBox(tab_3);
        GB_orden->setObjectName(QString::fromUtf8("GB_orden"));
        GB_orden->setGeometry(QRect(1140, 190, 120, 101));
        rb_post = new QRadioButton(GB_orden);
        rb_post->setObjectName(QString::fromUtf8("rb_post"));
        rb_post->setGeometry(QRect(10, 30, 97, 22));
        rb_inorden = new QRadioButton(GB_orden);
        rb_inorden->setObjectName(QString::fromUtf8("rb_inorden"));
        rb_inorden->setGeometry(QRect(10, 50, 97, 22));
        rb_preorden = new QRadioButton(GB_orden);
        rb_preorden->setObjectName(QString::fromUtf8("rb_preorden"));
        rb_preorden->setGeometry(QRect(10, 70, 97, 22));
    ...
    void retranslateUi(QMainWindow *cframe)
    {
        ...
        GB_orden->setTitle(QApplication::translate("cframe", "Tipo de orden", nullptr));
        rb_post->setText(QApplication::translate("cframe", "PostOrden", nullptr));
        rb_inorden->setText(QApplication::translate("cframe", "Inorden", nullptr));
        rb_preorden->setText(QApplication::translate("cframe", "Preorden", nullptr));
